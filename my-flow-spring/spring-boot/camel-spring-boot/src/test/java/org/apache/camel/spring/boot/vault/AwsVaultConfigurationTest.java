...
@SpringBootTest(classes = { AwsVaultConfigurationTest.class }, properties = {
        ...
        "camel.vault.aws.use-sqs-notification=true", "camel.vault.aws.sqs-queue-url=http://sqs-2",
        "camel.vault.aws.override-endpoint=true", "camel.vault.aws.uri-endpoint-override=http://localhost:8080" })
