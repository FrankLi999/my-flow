...
public class CamelMainListenerTest {
    ...
    private static final MyMainListener MY_MAIN_LISTENER = new MyMainListener();
    ...
    public void testMainListener() throws InterruptedException {
        ...
        Assertions.assertEquals("beforeInitialize", MY_MAIN_LISTENER.order.get(0));
        Assertions.assertEquals("beforeConfigure", MY_MAIN_LISTENER.order.get(1));
        Assertions.assertEquals("afterConfigure", MY_MAIN_LISTENER.order.get(2));
